import { BooleanAssertionFunction, ComparatorAssertionFunction, ErrorAssertionFunction, MessageAssertionFunction, RootTest, TestFunction, TestHarness } from './interfaces';
...
export declare const only: TestFunction;
...
export declare const createHarness: (opts?: {}) => TestHarness;
